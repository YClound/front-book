...
public class AcctInfoDAOImpl implements AcctInfoDAO {
	...
	public int updateByPrimaryKeySelective(AcctInfo record) throws SQLException {
		int rows = sqlMapClient.update("acct_info.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public AcctInfo selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		AcctInfo record = (AcctInfo) sqlMapClient.queryForObject(
				"acct_info.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(AcctInfoExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"acct_info.abatorgenerated_countByExample", example);
		return count.intValue();
	}

	public int updateByExampleSelective(AcctInfo record, AcctInfoExample example)
			throws SQLException {
