...
public class TraderInfoDAOImpl implements TraderInfoDAO {
	...
	public int updateByPrimaryKeySelective(TraderInfo record) throws SQLException {
		int rows = sqlMapClient.update("trader_info.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public List selectByExample(TraderInfoExample example) throws SQLException {
		List list = sqlMapClient.queryForList("trader_info.abatorgenerated_selectByExample",
				example);
		return list;
	}
	...
	public TraderInfo selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		TraderInfo record = (TraderInfo) sqlMapClient.queryForObject(
				"trader_info.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(TraderInfoExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"trader_info.abatorgenerated_countByExample", example);
		return count.intValue();
	}

	public int updateByExampleSelective(TraderInfo record, TraderInfoExample example)
			throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("trader_info.abatorgenerated_updateByExampleSelective",
				parms);
		return rows;
	}
	...
	public TraderInfo selectByUserId(Long userId) throws SQLException {
		...
		TraderInfo record = (TraderInfo) sqlMapClient.queryForObject(
				"trader_info.abatorgenerated_selectByUserId", key);
		return record;
	}
