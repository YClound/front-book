...
public class StockLogDAOImpl implements StockLogDAO {
	...
	public int updateByPrimaryKeySelective(StockLog record) throws SQLException {
		int rows = sqlMapClient.update("stock_log.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public StockLog selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		StockLog record = (StockLog) sqlMapClient.queryForObject(
				"stock_log.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(StockLogExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"stock_log.abatorgenerated_countByExample", example);
		return count.intValue();
	}

	public int updateByExampleSelective(StockLog record, StockLogExample example)
			throws SQLException {
	...
	public List<StockLog> queryByPage(StockLogQuery stockLogQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("stock_log.queryByPageCount",
				stockLogQuery);
