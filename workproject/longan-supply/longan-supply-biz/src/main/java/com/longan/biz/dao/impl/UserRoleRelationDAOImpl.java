...
public class UserRoleRelationDAOImpl implements UserRoleRelationDAO {
	...
	public int updateByPrimaryKeySelective(UserRoleRelation record) throws SQLException {
		int rows = sqlMapClient.update(
				"user_role_relation.abatorgenerated_updateByPrimaryKeySelective", record);
		return rows;
	}

	@SuppressWarnings("rawtypes")
	public List selectByExample(UserRoleRelationExample example) throws SQLException {
		List list = sqlMapClient.queryForList("user_role_relation.abatorgenerated_selectByExample",
				example);
		return list;
	}
	...
	public int deleteByExample(UserRoleRelationExample example) throws SQLException {
		int rows = sqlMapClient.delete("user_role_relation.abatorgenerated_deleteByExample",
				example);
		return rows;
	}
	...
	public int deleteByPrimaryKey(Integer id) throws SQLException {
		...
		int rows = sqlMapClient
				.delete("user_role_relation.abatorgenerated_deleteByPrimaryKey", key);
		return rows;
	}

	public int countByExample(UserRoleRelationExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"user_role_relation.abatorgenerated_countByExample", example);
		return count.intValue();
	}

	public int updateByExampleSelective(UserRoleRelation record, UserRoleRelationExample example)
			throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update(
				"user_role_relation.abatorgenerated_updateByExampleSelective", parms);
		return rows;
	}
	...
	@Override
	public List<UserInfo> queryUserRoleRelationByPage(UserInfoQuery userInfoQuery)
			throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("user_role_relation.queryForPageCount",
				userInfoQuery);
		userInfoQuery.setTotalItem(count);
		return (List<UserInfo>) sqlMapClient.queryForList(
				"user_role_relation.queryUserRoleRelationByPage", userInfoQuery);
	}
