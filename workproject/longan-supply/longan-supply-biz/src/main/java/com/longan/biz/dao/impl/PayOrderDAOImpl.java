...
public class PayOrderDAOImpl implements PayOrderDAO {
	...
	public int updateByPrimaryKeySelective(PayOrder record) throws SQLException {
		int rows = sqlMapClient.update("pay_order.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public PayOrder selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		PayOrder record = (PayOrder) sqlMapClient.queryForObject(
				"pay_order.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(PayOrderExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"pay_order.abatorgenerated_countByExample", example);
	...
	public List<PayOrder> queryByPage(PayOrderQuery payOrderQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("pay_order.queryByPageCount",
				payOrderQuery);
