...
public class RefundOrderDAOImpl implements RefundOrderDAO {
	...
	public int updateByPrimaryKeySelective(RefundOrder record) throws SQLException {
		int rows = sqlMapClient.update("refund_order.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public List selectByExample(RefundOrderExample example) throws SQLException {
		List list = sqlMapClient.queryForList("refund_order.abatorgenerated_selectByExample",
				example);
		return list;
	}
	...
	public RefundOrder selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		RefundOrder record = (RefundOrder) sqlMapClient.queryForObject(
				"refund_order.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(RefundOrderExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"refund_order.abatorgenerated_countByExample", example);
		return count.intValue();
	}

	public int updateByExampleSelective(RefundOrder record, RefundOrderExample example)
			throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("refund_order.abatorgenerated_updateByExampleSelective",
				parms);
		return rows;
	}
	...
	public List<RefundOrder> queryByPage(RefundOrderQuery refundOrderQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("refund_order.queryByPageCount",
				refundOrderQuery);
		refundOrderQuery.setTotalItem(count);
		return (List<RefundOrder>) sqlMapClient.queryForList("refund_order.queryByPage",
				refundOrderQuery);
	}
	...
	public List<RefundOrder> queryByExport(RefundOrderQuery refundOrderQuery) throws SQLException {
		return (List<RefundOrder>) sqlMapClient.queryForList("refund_order.queryByExport",
				refundOrderQuery);
	}
}