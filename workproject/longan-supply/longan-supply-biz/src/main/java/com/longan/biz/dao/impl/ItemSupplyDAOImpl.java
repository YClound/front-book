...
public class ItemSupplyDAOImpl implements ItemSupplyDAO {
	...
	public int updateByPrimaryKeySelective(ItemSupply record) throws SQLException {
		int rows = sqlMapClient.update("item_supply.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public List selectByExample(ItemSupplyExample example) throws SQLException {
		List list = sqlMapClient.queryForList("item_supply.abatorgenerated_selectByExample",
				example);
		return list;
	}
	...
	public ItemSupply selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		ItemSupply record = (ItemSupply) sqlMapClient.queryForObject(
				"item_supply.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(ItemSupplyExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"item_supply.abatorgenerated_countByExample", example);
		return count.intValue();
	}

	public int updateByExampleSelective(ItemSupply record, ItemSupplyExample example)
			throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("item_supply.abatorgenerated_updateByExampleSelective",
				parms);
		return rows;
	}
	...
	public ItemSupply selectForUpdate(Long id) throws SQLException {
		ItemSupply itemSupply = (ItemSupply) sqlMapClient.queryForObject("item_supply.forUpdate",
				id);
		return itemSupply;
	}
	...
	public List<ItemSupply> queryByPage(ItemSupplyQuery itemSupplyQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("item_supply.queryByPageCount",
				itemSupplyQuery);
		itemSupplyQuery.setTotalItem(count);
		return (List<ItemSupply>) sqlMapClient.queryForList("item_supply.queryByPage",
				itemSupplyQuery);
	}
