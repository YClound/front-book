...
public class RoleInfoDAOImpl implements RoleInfoDAO {
	...
	public int updateByPrimaryKeySelective(RoleInfo record) throws SQLException {
		int rows = sqlMapClient.update("role_info.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public RoleInfo selectByPrimaryKey(Integer id) throws SQLException {
		...
		key.setId(id);
		RoleInfo record = (RoleInfo) sqlMapClient.queryForObject(
				"role_info.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(RoleInfoExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"role_info.abatorgenerated_countByExample", example);
	...
	public List<RoleInfo> queryRoleInfoByPage(RoleInfoQuery roleInfoQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("role_info.queryByPageCount",
				roleInfoQuery);
