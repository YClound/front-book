...
public class UserInfoDAOImpl implements UserInfoDAO {
	...
	public int updateByPrimaryKeySelective(UserInfo record) throws SQLException {
		int rows = sqlMapClient.update("user_info.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public UserInfo selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		UserInfo record = (UserInfo) sqlMapClient.queryForObject(
	...
	public UserInfo selectDownStreamByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		UserInfo record = (UserInfo) sqlMapClient.queryForObject(
				"user_info.abatorgenerated_selectDownStreamByPrimaryKey", key);
		return record;
	}
	...
	public List<UserInfo> queryByPage(UserInfoQuery userInfoQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("user_info.queryByPageCount",
				userInfoQuery);
	...
	public List<UserInfo> queryDownStreamByPage(UserInfoQuery userInfoQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("user_info.queryForPageCount",
				userInfoQuery);
		userInfoQuery.setTotalItem(count);
		return (List<UserInfo>) sqlMapClient.queryForList("user_info.queryDownStreamInfoForPage",
				userInfoQuery);
	}
