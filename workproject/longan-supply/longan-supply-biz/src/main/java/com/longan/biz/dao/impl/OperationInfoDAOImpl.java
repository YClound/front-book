...
public class OperationInfoDAOImpl implements OperationInfoDAO {
	...
	public int updateByPrimaryKeySelective(OperationInfo record) throws SQLException {
		int rows = sqlMapClient.update(
				"operation_info.abatorgenerated_updateByPrimaryKeySelective", record);
		return rows;
	}

	@SuppressWarnings("rawtypes")
	public List selectByExample(OperationInfoExample example) throws SQLException {
		List list = sqlMapClient.queryForList("operation_info.abatorgenerated_selectByExample",
				example);
		return list;
	}
	...
	public OperationInfo selectByPrimaryKey(Integer id) throws SQLException {
		...
		key.setId(id);
		OperationInfo record = (OperationInfo) sqlMapClient.queryForObject(
				"operation_info.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(OperationInfoExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"operation_info.abatorgenerated_countByExample", example);
	...
	public int updateByExampleSelective(OperationInfo record, OperationInfoExample example)
		...
		int rows = sqlMapClient.update("operation_info.abatorgenerated_updateByExampleSelective",
				parms);
		return rows;
	}
	...
	public List<OperationInfo> selectOperationListByRole(Integer roleId, Integer type)
			throws SQLException {
		Map<String, Object> map = new HashMap<String, Object>(2);
		map.put("roleId", roleId);
		map.put("type", type);
		List<OperationInfo> result = (List<OperationInfo>) sqlMapClient.queryForList(
				"operation_info.selectOperationListByRole", map);
		return result;
	}

	@SuppressWarnings("unchecked")
	@Override
	public List<OperationInfo> queryOperationInfoByPage(OperationInfoQuery operationInfoQuery)
			throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("operation_info.queryByPageCount",
				operationInfoQuery);
		operationInfoQuery.setTotalItem(count);
		return (List<OperationInfo>) sqlMapClient.queryForList("operation_info.queryByPage",
				operationInfoQuery);
	}
	...
	public List<OperationInfo> queryOperationListByType(Integer type) throws SQLException {
		List<OperationInfo> list = (List<OperationInfo>) sqlMapClient.queryForList(
				"operation_info.queryByType", type);
		return list;
	}
	...
	public List<OperationInfo> queryAllOperationList() throws SQLException {
		List<OperationInfo> list = (List<OperationInfo>) sqlMapClient
				.queryForList("operation_info.queryAll");
		return list;
	}
}