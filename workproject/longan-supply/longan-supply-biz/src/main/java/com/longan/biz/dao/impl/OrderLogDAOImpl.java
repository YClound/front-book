...
public class OrderLogDAOImpl implements OrderLogDAO {
	...
	public int updateByPrimaryKeySelective(OrderLog record) throws SQLException {
		int rows = sqlMapClient.update("order_log.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public OrderLog selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		OrderLog record = (OrderLog) sqlMapClient.queryForObject(
				"order_log.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(OrderLogExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"order_log.abatorgenerated_countByExample", example);
