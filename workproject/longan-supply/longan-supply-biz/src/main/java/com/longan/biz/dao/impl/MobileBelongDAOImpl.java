...
public class MobileBelongDAOImpl implements MobileBelongDAO {
	...
	public int updateByPrimaryKeySelective(MobileBelong record) throws SQLException {
		int rows = sqlMapClient.update("mobile_belong.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public List selectByExample(MobileBelongExample example) throws SQLException {
		List list = sqlMapClient.queryForList("mobile_belong.abatorgenerated_selectByExample",
				example);
		return list;
	}
	...
	public MobileBelong selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		MobileBelong record = (MobileBelong) sqlMapClient.queryForObject(
				"mobile_belong.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(MobileBelongExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"mobile_belong.abatorgenerated_countByExample", example);
		return count.intValue();
	}

	public int updateByExampleSelective(MobileBelong record, MobileBelongExample example)
			throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("mobile_belong.abatorgenerated_updateByExampleSelective",
				parms);
		return rows;
	}
