...
public class ChargeOrderDAOImpl implements ChargeOrderDAO {
	...
	public int updateByPrimaryKeySelective(ChargeOrder record) throws SQLException {
		int rows = sqlMapClient.update("charge_order.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public List selectByExample(ChargeOrderExample example) throws SQLException {
		List list = sqlMapClient.queryForList("charge_order.abatorgenerated_selectByExample",
				example);
		return list;
	}
	...
	public ChargeOrder selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		ChargeOrder record = (ChargeOrder) sqlMapClient.queryForObject(
				"charge_order.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(ChargeOrderExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"charge_order.abatorgenerated_countByExample", example);
		return count.intValue();
	}

	public int updateByExampleSelective(ChargeOrder record, ChargeOrderExample example)
			throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update("charge_order.abatorgenerated_updateByExampleSelective",
				parms);
		return rows;
	}
	...
	public List<ChargeOrder> queryByPage(ChargeOrderQuery chargeOrderQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("charge_order.queryByPageCount",
				chargeOrderQuery);
		chargeOrderQuery.setTotalItem(count);
		return (List<ChargeOrder>) sqlMapClient.queryForList("charge_order.queryByPage",
				chargeOrderQuery);
	}
}