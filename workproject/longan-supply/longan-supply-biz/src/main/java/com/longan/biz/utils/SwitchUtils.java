...
public class SwitchUtils {
	...
	public static void setStaticFieldValue(String className, String fieldName, String value)
			throws Exception {
	...
	protected static Object[] getClassField(String className, String fieldName, boolean mustStatic)
			throws Exception {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println(SwitchUtils.getStaticFieldValue(className, "CHECK_AREA_SWITCH")
					.toString());
