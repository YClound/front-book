...
public class AreaInfoDAOImpl implements AreaInfoDAO {
	...
	public int updateByPrimaryKeySelective(AreaInfo record) throws SQLException {
		int rows = sqlMapClient.update("area_info.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public AreaInfo selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		AreaInfo record = (AreaInfo) sqlMapClient.queryForObject(
				"area_info.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(AreaInfoExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"area_info.abatorgenerated_countByExample", example);
