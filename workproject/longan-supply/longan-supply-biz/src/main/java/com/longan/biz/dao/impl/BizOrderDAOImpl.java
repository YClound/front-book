...
public class BizOrderDAOImpl implements BizOrderDAO {
	...
	public int updateByPrimaryKeySelective(BizOrder record) throws SQLException {
		int rows = sqlMapClient.update("biz_order.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public BizOrder selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		BizOrder record = (BizOrder) sqlMapClient.queryForObject(
				"biz_order.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(BizOrderExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"biz_order.abatorgenerated_countByExample", example);
	...
	public List<BizOrder> queryByPage(BizOrderQuery bizOrderQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("biz_order.queryByPageCount",
				bizOrderQuery);
