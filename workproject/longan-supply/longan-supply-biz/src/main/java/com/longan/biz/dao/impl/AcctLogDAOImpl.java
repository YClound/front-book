...
public class AcctLogDAOImpl implements AcctLogDAO {
	...
	public int updateByPrimaryKeySelective(AcctLog record) throws SQLException {
		int rows = sqlMapClient.update("acct_log.abatorgenerated_updateByPrimaryKeySelective",
				record);
		return rows;
	}
	...
	public AcctLog selectByPrimaryKey(Long id) throws SQLException {
		...
		key.setId(id);
		AcctLog record = (AcctLog) sqlMapClient.queryForObject(
				"acct_log.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(AcctLogExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"acct_log.abatorgenerated_countByExample", example);
	...
	public List<AcctLog> queryByPage(AcctLogQuery acctLogQuery) throws SQLException {
		int count = (Integer) sqlMapClient.queryForObject("acct_log.queryForPageCount",
				acctLogQuery);
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<AcctLog> queryByExport(AcctLogQuery acctLogQuery)
			throws SQLException {
