...
public class Stock {
	...
	public String getItemCostPriceDesc() {
		...
		Double result = BigDecimalUtils.doubleDiveid(String.valueOf(itemCostPrice));
	...
	public boolean showRed() {
		...
		return Constants.Stock.STATUS_EXCEPTION == status
				|| Constants.Stock.STATUS_INV_ALLOCATED == status;
	}
	...
	public boolean canReturnToStorage() {
		return status == Constants.Stock.STATUS_INV_ALLOCATED
				|| status == Constants.Stock.STATUS_EXCEPTION;
	}
