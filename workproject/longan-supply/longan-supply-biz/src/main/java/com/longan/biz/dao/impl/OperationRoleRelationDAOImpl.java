...
public class OperationRoleRelationDAOImpl implements OperationRoleRelationDAO {
	...
	public int updateByPrimaryKeySelective(OperationRoleRelation record) throws SQLException {
		int rows = sqlMapClient.update(
				"operation_role_relation.abatorgenerated_updateByPrimaryKeySelective", record);
		return rows;
	}
	...
	public List selectByExample(OperationRoleRelationExample example) throws SQLException {
		List list = sqlMapClient.queryForList(
				"operation_role_relation.abatorgenerated_selectByExample", example);
		return list;
	}
	...
	public int deleteByExample(OperationRoleRelationExample example) throws SQLException {
		int rows = sqlMapClient.delete("operation_role_relation.abatorgenerated_deleteByExample",
				example);
		return rows;
	}
	...
	public int deleteByPrimaryKey(Integer id) throws SQLException {
		...
		int rows = sqlMapClient.delete(
				"operation_role_relation.abatorgenerated_deleteByPrimaryKey", key);
		return rows;
	}

	public int countByExample(OperationRoleRelationExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"operation_role_relation.abatorgenerated_countByExample", example);
		return count.intValue();
	}

	public int updateByExampleSelective(OperationRoleRelation record,
			OperationRoleRelationExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update(
				"operation_role_relation.abatorgenerated_updateByExampleSelective", parms);
		return rows;
	}
	...
	public int deleteByRoleId(Integer roleId) throws SQLException {
		...
		int rows = sqlMapClient.delete("operation_role_relation.abatorgenerated_deleteByRoleId",
				key);
		return rows;
	}

	@Override
	public Boolean batchInsert(List<OperationRoleRelation> operationRoleRelationList)
			throws Exception {
		sqlMapClient.startBatch();
		for (OperationRoleRelation operationRoleRelation : operationRoleRelationList) {
			sqlMapClient.insert("operation_role_relation.abatorgenerated_insert",
					operationRoleRelation);
		}
