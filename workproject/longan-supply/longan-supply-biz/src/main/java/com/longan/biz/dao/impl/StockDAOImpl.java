...
public class StockDAOImpl implements StockDAO {
	...
	public Stock selectByPrimaryKey(Long id) throws SQLException {
		Stock key = new Stock();
		key.setId(id);
		Stock record = (Stock) sqlMapClient.queryForObject(
				"stock.abatorgenerated_selectByPrimaryKey", key);
		return record;
	}
	...
	public int countByExample(StockExample example) throws SQLException {
		Integer count = (Integer) sqlMapClient.queryForObject(
				"stock.abatorgenerated_countByExample", example);
	...
	@Override
	public int outStockByCount(Integer count, Long itemSupplyId, Long stockLogId)
			throws SQLException {
