...
public class QueryOperationLog extends BaseController {
	...
	public String index(@ModelAttribute("operationLogQuery") OperationLogQuery operationLogQuery,
			Model model) {
		return "system/queryOperationLog";
	}

	@RequestMapping(method = RequestMethod.POST)
	public String doQuery(@ModelAttribute("operationLogQuery") OperationLogQuery operationLogQuery,
			Model model) {
		Result<List<OperationLog>> result = operationLogService
				.queryOperationLogList(operationLogQuery);
