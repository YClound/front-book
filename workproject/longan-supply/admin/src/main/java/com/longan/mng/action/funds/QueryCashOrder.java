...
public class QueryCashOrder extends BaseController {
	...
	public void index(@ModelAttribute("cashOrderQuery") CashOrderQuery cashOrderQuery,
	...
	public void doQuery(@ModelAttribute("cashOrderQuery") CashOrderQuery cashOrderQuery,
	...
	public Map<String, String> statusList() {
		...
		map.put(Constants.CashOrder.STATUS_UNCONFIRMED + "",
				Constants.CashOrder.STATUS_UNCONFIRMED_DESC);
		return map;
	}
