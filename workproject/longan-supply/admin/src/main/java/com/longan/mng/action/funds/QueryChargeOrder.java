...
public class QueryChargeOrder extends BaseController {
	...
	public void index(@ModelAttribute("chargeOrderQuery") ChargeOrderQuery chargeOrderQuery,
	...
	public void doQuery(@ModelAttribute("chargeOrderQuery") ChargeOrderQuery chargeOrderQuery,
	...
	public Map<String, String> statusList() {
		...
		map.put(Constants.ChargeOrder.STATUS_SUCCESS + "",
				Constants.ChargeOrder.STATUS_SUCCESS_DESC);
		map.put(Constants.ChargeOrder.STATUS_UNCONFIRMED + "",
				Constants.ChargeOrder.STATUS_UNCONFIRMED_DESC);
		return map;
	}
