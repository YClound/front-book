...
public class PayOrderDeal extends BaseController {
	...
	public String onRequest(@RequestParam("payOrderId") Long payOrderId,
		...
		OperationLog operationLog = OperLogUtils.operationLogDeal(older, payOrderService
				.getPayOrder(payOrderId).getModule(), userInfo, map.get("moduleName"), older
