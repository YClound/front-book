...
public class QueryBizOrder extends BaseController {
	...
	@RequestMapping("biz/queryBizOrderIndex")
	public String index(@ModelAttribute("bizOrderQuery") BizOrderQuery bizOrderQuery,
		...
		this.setSelectValue(userInfo, model, bizOrderQuery);
	...
	public String doQuery(@ModelAttribute("bizOrderQuery") BizOrderQuery bizOrderQuery,
	...
	void setSelectValue(UserInfo userInfo, Model model, BizOrderQuery bizOrderQuery) {
		...
		model.addAttribute("bizName", Constants.BIZ_MAP.get(bizOrderQuery.getBizId()));
		model.addAttribute("bizId", bizOrderQuery.getBizId());
