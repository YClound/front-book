...
public class TaskDeal extends BaseController {
	...
	public String onEditIndex(@ModelAttribute("taskForm") TaskForm taskForm, HttpSession session,
			Model model) {
	...
	public Map<String, String> commitTypeList() {
		...
		map.put(Constants.Task.COMMIT_TYPE_TASK + "",
				Constants.Task.COMMIT_TYPE_TASK_DESC);
		return map;
	}
