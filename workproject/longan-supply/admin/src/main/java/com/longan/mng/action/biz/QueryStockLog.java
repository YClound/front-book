...
public class QueryStockLog extends BaseController {
	...
	@RequestMapping(value = "biz/queryStockLog.do", params = "requestType=index")
	public String index(@ModelAttribute("stockLogQuery") StockLogQuery stockLogQuery,
	...
	@RequestMapping(value = "biz/queryStockLog.do")
	public String doQuery(@ModelAttribute("stockLogQuery") StockLogQuery stockLogQuery,
	...
	void setSelectValue(UserInfo userInfo, Model model, StockLogQuery stockLogQuery) {
		Result<List<ItemSupply>> itemSupplyResult = itemService
				.queryItemSupplyByBizId(stockLogQuery.getBizId());
