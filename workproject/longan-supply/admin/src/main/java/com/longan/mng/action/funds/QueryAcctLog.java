...
public class QueryAcctLog extends BaseController {
	...
	public void index(@ModelAttribute("acctLogQuery") AcctLogQuery acctLogQuery, Model model,
			HttpSession session) {
	...
	public void doQuery(@ModelAttribute("acctLogQuery") AcctLogQuery acctLogQuery, Model model,
			HttpSession session) {
		UserInfo userInfo = super.getUserInfo(session);
		setSelectValue(model, userInfo, acctLogQuery);
		model.addAttribute("userInfo", userInfo);
		if (acctLogQuery.getId() != null || acctLogQuery.getBillId() != null
				|| acctLogQuery.getBizOrderId() != null) {
