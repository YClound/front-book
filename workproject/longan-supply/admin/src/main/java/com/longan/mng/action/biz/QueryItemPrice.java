...
public class QueryItemPrice extends BaseController {
	...
	public String index(@ModelAttribute("itemPriceQuery") ItemPriceQuery itemPriceQuery,
		...
		if (itemPriceList != null) {
			for (ItemPrice itemPrice : itemPriceList) {
				UserInfo supplyTrader = localCachedService.getUserInfo(itemPrice
						.getSupplyTraderId());
				...
				if (itemPrice.isNationwide()) {
					...
					itemPrice.setItemSalesAreaDesc(sb.toString().substring(0,
