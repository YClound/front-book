...
@Controller
public class QueryGameItemSupply extends BaseController {
	@Resource
	...
	@RequestMapping(value = "biz/queryGameItemSupply")
	public String index(@ModelAttribute("itemSupplyQuery") ItemSupplyQuery itemSupplyQuery,
