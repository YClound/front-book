...
public class CashOrderCreate extends BaseController {
	...
	public String onPostCreate(@ModelAttribute("cashOrderForm") CashOrderForm cashOrderForm,
		...
		if (result.isSuccess()) {
			...
			OperationLog operationLog = OperLogUtils.operationLogDeal(null, cashOrder, userInfo,
