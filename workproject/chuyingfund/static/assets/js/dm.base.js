        ...
        */
        ...
        function($) {
            $.fn.blockLoading = function(options) {
                return this.each(function() {
                    var n = $(this);
                    if ("hide" === options){n.html('');} 
                    else {
                        n.html('<div class="loading-message "><div class="block-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>')
                    }
