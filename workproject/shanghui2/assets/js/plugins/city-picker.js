...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        init: function () {
            //console.log(11,this,this.getPosition())
            this.defineDems();
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    (this.includeDem('district') ? '<a data-count="district">区县</a>' : '') + (this.includeDem('street') ? '<a data-count="street">街道</a>' : '') + '</div>' +
        ...
        refresh: function (force) {
            ...
            //console.log(111,this.$element.val(),this.$element)
            val = val.split(',');
            $.each(this.dems, $.proxy(function (i, type) {
        ...
        unbind: function () {
            ...
            if (this.$district) {
                this.$district.off(EVENT_CHANGE, this._changeDstrict);
            }
        },
        ...
        output: function (type) {
            ...
            //console.log('output',type,code)
            districts = $.isNumeric(code) ? ChineseDistricts[code] : null;
            //console.log('districts',districts,type)
            if ($.isPlainObject(districts) || (districts && districts.length)) {
                $.each(districts, function (code, address) {
                    //console.log('each',code, address)
                    var provs;
                    if (type === PROVINCE) {
                        provs = [];
