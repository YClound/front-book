/* 
    老乡审核模块 
*/
angular.module('awApp').controller("villagerCtrl", ["$scope", "$state" ,"$stateParams","resource","APPLY_STATUS",function(scope, state,stateParams,resource,APPLY_STATUS) {
    ...
    // 审核 action: 'yes' or 'no'; applyStatus: 0 待审核,1 已通过 ,2 已拒绝
