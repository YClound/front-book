/* 
    管理员模块 
*/
angular.module('awApp').controller("adminCtrl", ["$scope", "$state" ,"$stateParams","resource",function(scope, state,stateParams,resource) {
...
angular.module('awApp').controller("adminEditCtrl", ["$scope", "$state", "$stateParams","resource",function(scope, state,stateParams,resource) {
    var adminDao = resource('/admin');
    ...
    scope.save = function () {
        ...
        adminDao.invoke(method, scope.formData).then(function () {
