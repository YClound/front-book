		...
		'<div class="modal hide fade alert-box aw-favorite-box">'+
			'<div class="modal-dialog">'+
				'<div class="modal-content">'+
					...
					'</div>'+
					'<form action="' + API.updateFavoriteTag + '" method="post" onsubmit="return false;">'+
						'<div class="modal-body">'+
			...
			'<div class="modal fade alert-box aw-publish-box">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						...
						'<div class="modal-body">'+
							'<div class="alert alert-danger hide error_message"><i class="icon icon-delete"></i> <em></em></div>'+
							'<form action="' + API.publishQuestion + '" method="get" id="quick_publish" onsubmit="return false">'+
			...
			'<div class="modal fade alert-box aw-inbox">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						...
						'<div class="modal-body">'+
							'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
							'<form action="' + API.inboxSend + '" method="post" id="quick_publish" onsubmit="return false">'+
								'<input type="hidden" name="post_hash" value="' + G_POST_HASH + '" />'+
  ...
  // 评论框的样式
	'commentBox' : 
			'<div class="aw-comment-box" id="{{comment_form_id}}">'+
				...
				'<form action="{{comment_form_action}}" method="get" onsubmit="return false">'+
...
// 举报模板
			...
			'<div class="modal fade alert-box aw-share-box aw-share-box-message aw-report-box" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						...
						'</div>'+
						'<form id="quick_publish" method="post" action="' + API.saveReport + '">'+
	...
	'searchUser' :
		'<div class="aw-item">'+
		  '<a href="{{uhref}}" class="aw-user-img" data-id="{{uuid}}">'+
		    '<img src="{{user_pic}}" alt="" />'+
		  '</a>'+
		  '<p class="aw-title">' +
		    '<a href="{{uhref}}" target="_blank">{{search_query}}</a>'+
		  '</p>'+  
		  '<p class="aw-text-color-666">'+
		    '<span>'+
		      '<i class="icon icon-prestige"></i>威望{{prestige_count}}   </span>'+
		    '<span>'+
		      '<i class="icon icon-agree"></i> 赞同{{discuss_count}}   </span>'+
		    '<span>'+
		      '<i class="icon icon-thank"></i>感谢{{thank_count}}  </span>'+
		  '</p>'+
		'</div>',
	//搜索的话题列表
	'searchTopic' :
		'<div class="aw-item">'+
		  '<a href="single-topic-list.html" class="aw-topic-img" data-id="5">'+
		    '<img src="http://wenda.bootcss.com/static/common/topic-mid-img.png" alt="" />'+
		  '</a>'+
		  '<p class="aw-title">'+
		    '<span class="topic-tag">'+
		    '<a href="single-topic-list.html" class="text" target="_blank">bootstrap</a>'+
		    '</span>'+
		  '</p>'+  
		  '<p class="aw-text-color-666">'+
		    '<i class="icon icon-topic"></i> 56 个讨论'+      
		  '</p>'+
		'</div>',
	//搜索的问题列表
	//搜索的文章列表
